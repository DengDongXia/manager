...
<body>
	<div class='main'>
		...
		<div class="content">
			<div class="userInfo">
				<div class="userPic">
					...
					<p><span class='identify'>二级代理</span></p>
				</div>
				<div class="userText">
					...
					<p class='add'><span id='addAgent'>新增零售代理</span><a href="report.jsp"><span id='addgoods'>查看报表</span></a></p>
				</div>
		...
		<div class="addBg" id='adduserBg'>
			<div class="addForm">
				<p class='addTitle'>新增零售代理</p>
				<p><input type="text" name="" id='name' placeholder="请输入新增的零售代理名称"></p>
				<p><input type="eamil" name="" id='email' placeholder="请输入新增的零售代理邮箱"></p>
				<p><input type="password" name="" id='password' placeholder="请输入密码"></p>
				<p><input type="text" name="" id='quote' placeholder="请输入新增的零售代理的个性签名"></p>
				<p><input type="file" name="" id='pic'></p>
				<p class='checkBg'><label><input type="checkbox" id='check' name="power" checked>允许代理</label></p>
				<p><input type="button" name="" value='新增零售代理' class='submitForm' id='addUserButton'></p>
			</div>	
		</div>
